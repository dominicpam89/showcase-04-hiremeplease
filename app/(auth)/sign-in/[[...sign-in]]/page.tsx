...
import AuthCardHeaderTitle from "@/components/auth/card-header-title";
					...
					{(isGlobalLoading) => (
						<>
							<SignIn.Step name="start">
								<Card className="w-full sm:w-96 font-primary">
									<CardHeader className="text-center">
										<AuthCardHeaderTitle />
										<CardDescription className="px-4 text-justify opacity-80">
											Create account to start TeaTac, Teach and
											Tackle. Thus as homo sapiens, life would not be
											meaningless.
										</CardDescription>
									</CardHeader>
							...
							<SignIn.Step name="choose-strategy">
								<Card className="w-full sm:w-96">
									<CardHeader>
										...
										<CardDescription>
											Facing issues? You can use any of these methods
											to sign in.
										</CardDescription>
									</CardHeader>
									<CardContent className="grid gap-y-4">
