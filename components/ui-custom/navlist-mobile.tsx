...
export default function NavlistMobileUI() {
     const { open, onOpenChange, toggleClose } =
          useCommonToggle()
               ...
               >
                    <SheetHeader>
                         ...
                         <SheetDescription className="text-xs text-justify leading-4">
                              Welcome to TeaTac (Teach and
                              Tackle), where students ask
                              the real questions and
                              teachers drop the knowledge
                              bombs—sometimes with a side of
                              sarcasm!
                         </SheetDescription>
